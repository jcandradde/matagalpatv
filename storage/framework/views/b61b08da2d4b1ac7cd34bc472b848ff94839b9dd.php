...
<html lang="es">
  <head>
    ...
    <link rel="icon" href="<?php echo e(asset('favicon9.ico')); ?>">
...
<!--    <link href="<?php echo e(asset('css/bootstrap.min.css')); ?>" rel="stylesheet">-->
  ...
  <body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
      <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="<?php echo e(url('/home')); ?>">MATAGALPATV</a>
...
<!--          <a class="nav-link" href="#">Registro</a>-->
              <?php if(Route::has('login')): ?>
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <a class="nav-link text-light" href="<?php echo e(url('/home')); ?>">Salir</a>
                    <?php else: ?>
                           <a class="nav-link"  href="<?php echo e(route('login')); ?>">Inicio</a>
...
<!--
    <script src="--<?php echo e(asset('js/jquery-slim.min.js')); ?>" type="text/javascript"></script>
    <script>window.jQuery || document.write('<script src="<?php echo e(asset('js/jquery-slim.min.js')); ?>')</script>
-->
